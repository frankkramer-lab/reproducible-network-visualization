...
![NDExEdit: upload networks](img/NDExEdit/NDExEdit_upload.png)
...
![Blank network with circular layout applied](img/NDExEdit/NDExEdit-with-combined-subnetworks-loaded.png)
...
![Edit tab with shown node properties subchapter](img/NDExEdit/NDExEdit-edit-tab.png)
...
![Editing node properties](img/NDExEdit/NDExEdit-node-default-properties-edit.png)
...
![Accepting or cancling the changes](img/NDExEdit/NDExEdit-editing-mode.png)
...
![Create an continuous mapping for node color and size, node label size base on gene occurances](img/NDExEdit/NDExEdit-node-mapping-continuous-create.png)
...
![Created continuous mapping for gene occurrences](img/NDExEdit/NDExEdit-node-mapping-continuous-created.png)

\newpage

Also the graph is updated immediately after:

![Network visualization based on gene occurences across patients](img/NDExEdit/NDExEDIT-occurrences.png)

\newpage

The network now can be exported in different formats, namely PNG, JPEG, or downloaded as CX file.

![Export options for the network with included visualization](img/NDExEdit/NDExEdit-export-options.png)
...
![Export the network directly to the NDEx platform](img/NDExEdit/NDExEdit-export-to-NDEx.png)
...
![Discrete mapping for the gene expression levels and MTB results](img/NDExEdit/NDExEdit-GSM615368-discrete.png)
...
![Continous mapping based on the relevance score of patient GSM615368](img/NDExEdit/NDExEdit-GSM615368-continuous.png)

\newpage

The finished network looks as follows:

![Discrete mapping based on the gene expression level of patient GSM615368 on NDExEdit](img/NDExEdit/NDExEdit-GSM615368-visualization.png)
